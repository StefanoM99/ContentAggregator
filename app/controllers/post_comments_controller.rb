class PostCommentsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @post_comment.save
        format.html { redirect_to post_path(@post_comment.post.id), notice: "Post comment was successfully created." }
  ...
  def update
    respond_to do |format|
      if @post_comment.update(post_comment_params)
        format.html { redirect_to post_path(@post_comment.post.id), notice: "Post comment was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to post_path(@post_comment.post.id), notice: "Post comment was successfully destroyed." }
  ...
  private
    ...
    def post_comment_params
      params.require(:post_comment).permit(:author, :description, :user_id, :post_id)
    end
end
