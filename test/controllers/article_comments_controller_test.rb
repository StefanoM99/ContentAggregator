...
class ArticleCommentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create article_comment" do
    assert_difference("ArticleComment.count") do
      post article_comments_url, params: { article_comment: { author: @article_comment.author, description: @article_comment.description } }
    end
  ...
  test "should update article_comment" do
    patch article_comment_url(@article_comment), params: { article_comment: { author: @article_comment.author, description: @article_comment.description } }
